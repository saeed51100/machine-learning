...
I have written the following question to ask the AI.
Please read it carefully and only modify the last part (Deliverable) if necessary.
Is the order of the 4 items correct?
...
Deliverable
# --------------------------
* As I said above, df_model is ready. You just write me the sections in the following order:
