...
* As I said above, df_model is ready.
You just write me the sections "CHRONOLOGICAL SPLITTING" and "IMBALANCE HANDLING" and "SCALING DATA" in the correct order.
I will write the MODEL, PREDICTION, and VISUALIZATION sections later.